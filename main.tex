...
Permalink: \url{https://github.com/rachelsfba/physics-formula-sheet}
}
...
\date{Last Updated: 5 August 2021}%needs to be manually set on sharelatex since every webpage reload is a recompile (I think)
% END TITLE SETTINGS
...
\setlength\parskip{0em}%remove line spacing for table of contents
 ...
 \pgfplotsset{compat=1.17}%something about pgfplots compatibility recommended by the pdflatex compiler
